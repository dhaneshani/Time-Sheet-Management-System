...
$_SESSION['History']="user";
$result = sqlsrv_query($conn,"SELECT * FROM timeSheet WHERE UserName='$user' AND Confirmation='No'");
		...
		//echo '<td align="center"><form><button onclick="myFunction(' . $row['ID'] .')">Confirm</button></form></td>';
